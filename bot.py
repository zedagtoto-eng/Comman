    ...
    try:
        ...
        if bot_member is not None:
            ...
            if not bot_member.guild_permissions.manage_channels:
                ...
                return await ctx.send(
                    "â I need the **Manage Channels** permission."
                )
        ...
        if claimed_id != 0:
            ...
            return await ctx.send(
                "â This ticket is already claimed."
            )
        ...
        if middleman_role:
            ...
            try:
                ...
                return await ctx.send(
                    "â I couldn't hide this ticket from "
                    "the Middleman role.\n"
        ...
        try:
            ...
            return await ctx.send(
                "â I couldn't give you access to this ticket."
            )
    ...
    try:
        ...
        if middleman_role:
            ...
            try:
                ...
                return await ctx.send(
                    "â I couldn't restore access for the "
                    "Middleman role."
                )
    ...
    try:
        ...
        if middleman_role:
            ...
            try:
                ...
                return await ctx.send(
                    "â I couldn't update the Middleman "
                    "permissions."
                )
...
async def create_ticket_transcript(channel):
    """
    Builds a standalone HTML transcript containing the ticket's
    messages, authors, timestamps, message content and attachments.
    """
    ...
    for message in messages:
        ...
        # Preserve line breaks and safely escape HTML.
        ...
        if not content_html:
            content_html = "<i>No message content</i>"
    ...
    if not rows:
        rows.append(
            '<div class="message"><i>No messages found.</i></div>'
        )
...
async def close_ticket(ctx):
    ...
    try:
        ...
        if not TRANSCRIPT_CHANNEL_ID:
            return await ctx.send(
                "â `TRANSCRIPT_CHANNEL_ID` is not configured. "
        ...
        if not isinstance(
            ...
            return await ctx.send(
                "â The configured transcript channel was not found "
                "in this server."
            )
        ...
        if not permissions.view_channel:
            return await ctx.send(
                "â I cannot view the transcript channel."
            )

        if not permissions.send_messages:
            return await ctx.send(
                "â I cannot send messages in the transcript channel."
            )

        if not permissions.attach_files:
            return await ctx.send(
                "â I cannot upload transcript files in the "
                "transcript channel."
            )
        ...
        try:
            ...
            return await ctx.send(
                "â I don't have permission to read the ticket "
                "history, so the transcript could not be created."
            )

        except discord.HTTPException as error:
            return await ctx.send(
                f"â Discord failed while reading the ticket: "
        ...
        transcript_file = discord.File(
            ...
            filename=f"{channel_name}-transcript.html"
        )

        transcript_embed = discord.Embed(
            title="ð Ticket Transcript",
            description=(
        ...
        try:
            ...
            return await ctx.send(
                "â I could not send the transcript. "
                "The ticket was **not deleted**."
            )

        except discord.HTTPException as error:
            return await ctx.send(
                f"â Failed to upload the transcript: `{error}`\n"
                "The ticket was **not deleted**."
            )
        ...
        closing_embed = discord.Embed(
            title="ð Ticket Closing",
            description=(
                f"This ticket is being closed by "
                f"{ctx.author.mention}.\n\n"
                "â Transcript saved successfully.\n"
        ...
        try:
            ...
            try:
                await ctx.send(
                    "â The transcript was saved, but I don't have "
...
async def help_command(ctx):
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`$close` â Close and delete current ticket\n"
...
async def on_command_error(
    ...
    if isinstance(
        ...
        print(
            f"â Error in command `{ctx.command}`"
        )
...
async def on_ready():
    ...
    print(
        "â $trigger application system loaded"
    )

    print(
        "â Accept / Decline buttons loaded"
    )

    print(
        "â Application role system loaded"
    )

    print(
        "â New Flopper system loaded"
    )

    print(
        "â Ticket commands loaded"
    )
